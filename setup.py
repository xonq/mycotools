...
setuptools.setup(
    ...
    scripts = ['mycotools/abstractHmm.py', 'mycotools/acc2fa.py', 'mycotools/acc2gff.py', 'mycotools/annotationStats.py', 'mycotools/assemblyStats.py', 'mycotools/curAnnotation.py', 'mycotools/db2hmmsearch.py', 'mycotools/grabClusters.py', 'mycotools/jgiDwnld.py', 'mycotools/ncbiDwnld.py', 'mycotools/proteomeStats.py', 'mycotools/queryDB.py', 'mycotools/ncbi2db.py', 'mycotools/abstractDB.py', 'mycotools/predb2db.py', 'mycotools/updateDB.py', 'mycotools/jgi2db.py', 'mycotools/dbFiles.py', 'mycotools/gff2gff3.py'],
