...
setuptools.setup(
    ...
    scripts = ['mycotools/mycotools/acc2fa.py', 'mycotools/mycotools/acc2gff.py', 'mycotools/mycotools/aggClus.py', 'mycotools/mycotools/annotationStats.py', 'mycotools/mycotools/assemblyStats.py', 'mycotools/mycotools/curAnnotation.py', 'mycotools/mycotools/db2blast.py', 'mycotools/mycotools/db2hmmsearch.py', 'mycotools/mycotools/dbFiles.py', 'mycotools/mycotools/fa2tree.py', 'mycotools/mycotools/jgiDwnld.py', 'mycotools/mycotools/ncbiDwnld.py', 'mycotools/mycotools/ome2name.py', 'mycotools/mycotools/proteomeStats.py', 'mycotools/mycotools/predb2db.py', 'mycotools/mycotools/fa2hmmer2fa.py', 'mycotools/mycotools/extractDB.py', 'mycotools/mycotools/mycodb', 'mycotools/mycotools/utils/queryDB.py'],
