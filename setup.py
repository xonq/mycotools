...
setuptools.setup(
    ...
    scripts = ['mycotools/abstractHmm.py', 'mycotools/acc2fa.py', 'mycotools/acc2gff.py', 'mycotools/aggClus.py', 'mycotools/annotationStats.py', 'mycotools/assemblyStats.py', 'mycotools/curAnnotation.py', 'mycotools/db2blast.py', 'mycotools/db2hmmsearch.py', 'mycotools/dbFiles.py', 'mycotools/fa2tree.py', 'mycotools/gff2protein.py', 'mycotools/grabClusters.py', 'mycotools/jgiDwnld.py', 'mycotools/ncbiDwnld.py', 'mycotools/ome2name.py', 'mycotools/proteomeStats.py', 'mycotools/abstractDB.py', 'mycotools/updateDB.py', 'mycotools/predb2db.py', 'mycotools/utils/queryDB.py'],
