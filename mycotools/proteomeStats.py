...
def protStats( fa_path, output ):
    ...
    if not output:
        print( '{:<30}'.format('PROTEIN LENGTH:') + str(total) )
        print( '{:<30}'.format('PROTEINS:') + str(len(fa)))
        print( '{:<30}'.format('MEAN PROTEIN LENGTH:') + str(total/len(fa)))
        print( '{:<30}'.format('MEDIAN PROTEIN LENGTH:') + str(median))
        protStats = None
    else:
