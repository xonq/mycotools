...
import numpy as np
import sys, os, time, kontools.fastatools, json, re, datetime
from kontools.kontools import collect_files, eprint, formatPath
...
def masterDB( path = '$DB' ):
    ...
    try:
        ...
        master_path = formatPath( '$' + path + '/' + date + '.db' )
    except KeyError:
