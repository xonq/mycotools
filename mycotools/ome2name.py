...
def main(
    ...
    ome2name = {
        k: v for k, v in sorted(ome2name.items(), key=lambda x: len(x[0]), reverse=True)
    }
...
def cli():
    ...
    data_output = main(db, data_input, g, sp, st, ome_code, alt, rank=rank)
